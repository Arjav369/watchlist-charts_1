...
// ---- Design tokens ----
// Palette: ink (#11161C bg), paper (#F7F5F0 card), signal-green (#2E7D5B gains),
// signal-rust (#B5482A losses), mute (#6B7280 labels), line (#27313C hairline)
// Type: display = "Fraunces" (serif, characterful, for symbols/headers)
//       body/data = "IBM Plex Mono" (utility face, since this is a numbers/charts tool)
